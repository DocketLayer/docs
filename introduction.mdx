---
title: Introduction
description: Court docket monitoring for AI agents across 2,148 US and Canadian courts. Pay per query. $0.99 USDC via x402. No accounts.
---

DocketLayer is a pay-per-query API that gives AI agents programmatic access to court docket monitoring across 2,148 courts — all 50 US state court systems, all US federal courts, and Canadian federal and provincial courts.
